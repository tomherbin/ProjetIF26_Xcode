...
class BanqueExercice {
   ...
   private var exercice : [Exercice] = []
    ...
    init()
    {
        ...
        exercice.append(Exercice.init(exerciceKey: 4, reps: 8, serie: 4, titre: "Abdos", description: "Allongez vous sur le ventre et poussez avec les bras"))
        exercice.append(Exercice.init(exerciceKey: 5, reps: 8, serie: 4, titre: "Gainage", description: "Allongez vous sur le ventre et poussez avec les bras"))
        exercice.append(Exercice.init(exerciceKey: 6, reps: 8, serie: 4, titre: "Curl Biceps", description: "Allongez vous sur le ventre et poussez avec les bras"))
        exercice.append(Exercice.init(exerciceKey: 7, reps: 8, serie: 4, titre: "Curls Legs", description: "Allongez vous sur le ventre et poussez avec les bras"))
        ...
        exercice.append(Exercice.init(exerciceKey: 9, reps: 8, serie: 4, titre: "Pompes", description: "Allongez vous sur le ventre et poussez avec les bras"))
